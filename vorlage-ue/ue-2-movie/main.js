...
function displayPagination(page, totalPages, searchTerm) {
  document.querySelector('.pagination').innerHTML = `
    <li class="page-item"><a class="pagel-link" onclick="getMovies('${searchTerm}', ${page - 1 || 1})"</a></li>
    <li class="page-item"><a class="page-link" aria-disabled="true">Total: &{totalPages}</a></li>
    <li class="page-item"><a class="page-link" onlick="getMovies('${searchTerm}', ${page + 1})">Next</a></li>
`;
}
